                          ...
                          <a-form layout="horizontal" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
                            ...
                            <div
                              ...
                              <div v-for="(testCase, index) in evaluationFormData.testContent" :key="testCase.id"
                                ...
                                <a-textarea v-model:value="testCase.arg" placeholder="请输入输入内容" class="test-case-input"
                                  :auto-size="{ minRows: 3 }" />
                                <a-textarea v-model:value="testCase.answer" placeholder="请输入期望输出"
                                  class="test-case-output" :auto-size="{ minRows: 3 }" />
