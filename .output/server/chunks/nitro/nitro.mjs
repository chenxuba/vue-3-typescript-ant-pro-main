...
const _Hmie71 = eventHandler((event) => {
...
const _lazy__YR0oB = () => import('../routes/list/consult-list.post.mjs');
const _lazy_7VGE2v = () => import('../routes/list/create.post.mjs');
const _lazy_WrNzvn = () => import('../routes/list/crud-table.post.mjs');
const _lazy_UFJepS = () => import('../routes/index.post.mjs');
const _lazy_iyIZYs = () => import('../routes/index.put.mjs');
const _lazy_1y92kW = () => import('../routes/login.post.mjs');
const _lazy_mpi3sf = () => import('../routes/logout.mjs');
const _lazy_DwmP7_ = () => import('../routes/index2.mjs');
const _lazy_A13qtQ = () => import('../routes/organization/_id_.get.mjs');
const _lazy_HG0bS0 = () => import('../routes/organization/tree.mjs');
const _lazy_JwQ4Br = () => import('../routes/personnel/_id_.get.mjs');
const _lazy_dfp2tI = () => import('../routes/personnel/_id/status.put.mjs');
const _lazy_4THXJ_ = () => import('../routes/personnel/list.post.mjs');
const _lazy_CridtN = () => import('../routes/role-assignment/_id_.get.mjs');
const _lazy_CNNrec = () => import('../routes/role-assignment/batch-delete.post.mjs');
const _lazy_nXOHqB = () => import('../routes/role-assignment/create.post.mjs');
const _lazy_JD1wA7 = () => import('../routes/role-assignment/list.post.mjs');
const _lazy_V38yBI = () => import('../routes/role/_id_.delete.mjs');
const _lazy_QQyUSE = () => import('../routes/role/_id_.get.mjs');
const _lazy_SPPR86 = () => import('../routes/role/_id_.put.mjs');
const _lazy_qIWuek = () => import('../routes/role/_id/permissions.get.mjs');
const _lazy_M2ig9h = () => import('../routes/role/_id/permissions.post.mjs');
const _lazy_3yyIjM = () => import('../routes/role/_id/status.put.mjs');
const _lazy_XqQYN3 = () => import('../routes/role/batch-delete.post.mjs');
const _lazy_3AKOu8 = () => import('../routes/role/create.post.mjs');
const _lazy_tvNxaf = () => import('../routes/role/list.post.mjs');
const _lazy_a_2pXV = () => import('../routes/test.delete.mjs');
const _lazy_uEKqeI = () => import('../routes/test.post.mjs');
const _lazy_4F33dK = () => import('../routes/test.put.mjs');
const _lazy_EfnYIy = () => import('../routes/user/info.mjs');

const handlers = [
  { route: '', handler: _Hmie71, lazy: false, middleware: true, method: undefined },
